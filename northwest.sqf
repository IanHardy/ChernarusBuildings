...
if (true) then
{
  _this = createVehicle ["Land_fort_bagfence_long", [4655.1001, 9594.3213, 0.085861616], [], 0, "CAN_COLLIDE"];
  _vehicle_344 = _this;
  _this setDir 81.926155;
  _this setPos [4655.1001, 9594.3213, 0.085861616];
};
*/
